...
void envoiCarteJoueur(int cartes[],joueur_ *joueurs, char buffer[])
{
  joueur_ * j1 = joueurs;
  ...
  int i = 1;
  if (Cp1cards0[i-1] > 0 && Cp1cards0[i-1] < 10){
    strcpy(&envoiCarteJ1[i],"0");
    strcpy(&envoiCarteJ1[i+1],&Cp1cards0[i-1]);
  }else{
    strcpy(&envoiCarteJ1[i],&Cp1cards0[i-1]);
  }
  i=3;
  if (Cp1cards1[i-3] > 0 && Cp1cards1[i-3] < 10){
    strcpy(&envoiCarteJ1[i],"0");
    strcpy(&envoiCarteJ1[i+1],&Cp1cards1[i-3]);
  }else{
    strcpy(&envoiCarteJ1[i],&Cp1cards1[i-3]);
  }
  i=5;
  if (Cbcards0[i-5] > 0 && Cbcards0[i-5] < 10){
    strcpy(&envoiCarteJ1[i],"0");
    strcpy(&envoiCarteJ1[i+1],&Cbcards0[i-5]);
  }else{
...
//shuff the cards
  ...
  envoiCarteJoueur(cards, joueurs, buffer);
}
